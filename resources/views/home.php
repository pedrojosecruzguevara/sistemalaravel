  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"><b>Pyma</b></span>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="javascript:void(0);" onclick="cargarformulario(2);"><i class="fa fa-circle-o"></i>Cargar Datos Usuario </a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="javascript:void(0);" onclick="cargarlistado(4,1);"><i class="fa fa-circle-o"></i> Gráficas </a></li>
            </ul>
          </li>
        </ul>
      </section>
    ...
    <div class="content-wrapper" style="min-height:2000px !important;">
      ...
      if ($usuario->tipoUsuario != 1) {
        include('menus/submenu_standard.php');
      }    ?>
      <!-- contenido principal -->
