<div class="row">
        ...
        <div class="box-body ">
          ...
          <div class="form-group col-xs-12">
            ...
            <select id="pais" name="pais" class="form-control">
              ...
              <option value="149 ">República Democrática del Congo</option>
              ...
              <option value="170 ">Sudáfrica</option>
              <option value="171 ">Sudán del Norte</option>
              <option value="172 ">Sudán del Sur</option>
  ...
  <div class="col-md-6">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Cambiar Fotografía</h3>
      </div><!-- /.box-header -->
        ...
        <div class="box-body">
          <div class="form-group col-xs-12">
            <?php if ($usuario->imagenurl == "") {
              $usuario->imagenurl = url("imagenes/avatar.jpg");
            }  ?>
