     ...
     <div class="col-md-6">
          <div class="box box-primary">
               ...
               <form id="f_agregar_publicacion" method="post" action="agregar_publicacion_usuario" class="formarchivo">
                    ...
                    <div class="box-body ">
                         <div class="col-xs-12">
                              <label for="pais">Tipo de Publicación</label>
                         ...
                         <div class="col-xs-12">
                              <label for="apellido">Título del Trabajo</label>
                         ...
                         <div class=" col-xs-12" id="info_libro" style="display:none;">
                              ...
                              <div class=" col-xs-4">
                                   <label for="apellido">Edición</label>
