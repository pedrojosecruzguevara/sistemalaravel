      ...
      <div class="box box-solid">
        ...
        <div class="box-body ">
          <ul class="nav nav-pills nav-stacked">
            ...
            <li style="line-height: 25px;"><span><i class="fa fa-circle-o text-light-blue"></i> <label for="nombre">Ocupación:</label><span style="margin-left:15px;"><?= $usuario->ocupacion; ?></span></span></li>
      ...
      <div class="box box-primary">
        <div class="box-body box-profile">
          <?php if ($usuario->imagenurl == "") {
            $usuario->imagenurl = "imagenes/avatar.jpg";
          }  ?>
          ...
          <ul class="list-group list-group-unbordered">
            <li class="list-group-item">
              <b>País</b> <a class="pull-right"><?= $usuario->delpais->nombre;  ?></a>
            </li>
            <li class="list-group-item">
              ...
              <li class="list-group-item">
                ...
                <?php foreach ($publicaciones->get() as $archivo) {  ?>
                  <?php if ($archivo->idTipopublicacion == $tipo->id) {   ?>
                    ...
                    <br /> <span><b>País: </b>-<?= $archivo->pais;  ?></span> <span><b>Año: </b>-<?= $archivo->anio;  ?></span>
          ...
          <ul class="list-group list-group-unbordered">
            <?php foreach ($proyectos->get() as $archivo) {  ?>
              <li class="list-group-item">
                ...
                <br /> <span><b>Descripción: </b>-<?= $archivo->descripcion;  ?></span>
