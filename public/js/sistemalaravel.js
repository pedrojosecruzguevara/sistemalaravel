...
function cargarformulario(arg) {
  //función que carga todos los formularios del sistema
...
$(document).on("submit", ".form_entrada", function (e) {
  //funcióon para atrapar los formularios y enviar los datos
  e.preventDefault();
  ...
  if (quien == "f_agregar_educacion") { var varurl = "agregar_educacion_usuario"; var divresul = "notificacion_resul_faedu"; rs = true; }  //lección 10
...
$(document).on("click", ".pagination li a", function (e) {
  //para que la página se cargen los elementos
  e.preventDefault();
...
function mostrarficha(id_usuario, tipo) {
  //función para mostrar y etditar la informacion del usuario
  $("#usuario_seleccionado").val(id_usuario); //lección10
  $("#capa_modal").show();
  $("#capa_para_edicion").show();
  if (tipo == 1) { var url = "form_editar_usuario/" + id_usuario + ""; } else { var url = "info_datos_usuario/" + id_usuario + ""; }
  $("#contenido_capa_edicion").html($("#cargador_empresa").html());  //lección 10
  $.get(url, function (resul) {
    $("#contenido_capa_edicion").html(resul);  //lección 10
  })
  irarriba();
}

$(document).on("click", ".div_modal", function (e) {
  //función para ocultar las capas modales
  $("#capa_modal").hide();
  $("#capa_para_edicion").hide();
  $("#contenido_capa_edicion").html("");  //lección 10
})
...
function mostrarseccion(arg) {
  ...
  if (arg == 3) { var url = "form_publicaciones_usuario/" + id_usuario + ""; } //lección 11
  if (arg == 4) { var url = "form_proyectos_usuario/" + id_usuario + ""; } //lección 11
