...
class UsuariosController extends Controller
{
	...
	public function agregar_nuevo_usuario(Request $request)
	{
		...
		$mensajes = array(
			...
			'email.unique' =>  'El email debe ser único en la base de datos',
			'telefono.required' =>  'Ingresar un teléfono es obligatorio y será númerico entre 10 y 15 dígitos',
	...
	{
		//función para cargar los datos de cada usuario en la ficha
	...
	public function subir_imagen_usuario(Request $request)
	{
		...
		if ($validacion->fails()) {
			return view("mensajes.msj_rechazado")->with("msj", "El archivo no es una imagen válida");
		} else {
			...
			if ($r1) {
				...
				return view("mensajes.msj_rechazado")->with("msj", "No se cargó la imagen");
			}
		}
	}
